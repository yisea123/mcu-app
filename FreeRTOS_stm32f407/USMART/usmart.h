...
#define MAX_FNAME_LEN 		50	//函数名最大长度，应该设置为不小于最长函数名的长度。											   
...
extern void usamrt_debug_task(void *argc);
//extern OS_EVENT *mMsgQUart;
#endif
