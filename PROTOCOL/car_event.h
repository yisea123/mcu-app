...
extern int phase_can1_fifo(/*struct kfifo *mfifo*/void *fifo, char cmd[], int *cmd_len, int fifoClean);
extern int phase_can2_fifo(/*struct kfifo *mfifo*/void *fifo, char cmd[], int *cmd_len, int fifoClean);
